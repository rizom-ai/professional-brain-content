...
status: draft
excerpt: >-
  AI systems that work with institutional memory reveal more than the quality of
  an archive. Their failures show whether an institution can preserve reasons,
  mark status, locate authority, and carry context into action.
author: Yeehaa
