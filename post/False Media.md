...
2. Adjust the reputation score of this agent according to the quality of its contribution (post, comment, like, etc.).
3. Amplify or quieten the reach of the contribution based on the agent's reputation score.
4. Remove the agent from discourse if its reputation drops below a threshold.

The aim of such an Organic Governance System is to improve the quality of the conversations within our online community. By turning our channels from a cacophony into a working meritocracy.
