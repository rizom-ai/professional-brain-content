...
Founded a structured matchmaking event series connecting startups with high-value connectors. The format — in which founders pitch a critical ask and connectors compete to provide the best match — has been adopted across the Netherlands and expanded internationally, including to Japan.
...
- Assistant Professor in Cultural Analysis *(August 2005 – December 2016)*
    - Developed and taught cross-disciplinary curricula and research projects at bachelor's, master's, and staff levels. Key projects:
    - *Coding the Humanities* (2013–2015): One of the first programming bootcamps in the Netherlands, integrating software development with humanities research
    - *Augmenting Masterpieces* (2014–2015): Research project at the Rijksmuseum; nominated for the Best of the Web award (Museums and the Web, 2015)
- Human Resources Manager *(September 2011 – September 2012)*
    - Designed a training curriculum for new academic staff and developed a policy framework for job mobility within the faculty.
- Guest Researcher, Faculty of Humanities *(January 2017 – December 2018)*

**Dev Bootcamp — Coach & Teaching Assistant** *(June 2013 – September 2013 | San Francisco)*
Coached and supervised students; delivered lectures throughout the intensive software development program.
...
- *Off Beat: Pluralizing Rhythm* (Amsterdam, 2013) — Essay collection on rhythm as an analytical tool for cultural objects
- "Oh Baby I Like It Raw" in *Sonic Meditations* (Cambridge, 2008)
- "New Adventures in Low Fidelity" in *Image and Narrative* (Leuven, 2008)
- "Aus der Spur Geraten" in *Lettre International* (Berlin, 2002)
- *Time Tracks* — PhD dissertation (Utrecht, 2005)
