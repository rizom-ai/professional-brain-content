...
The following are selected pieces from an ongoing essay series, "New Institutions," where I've been developing — in public, over time — the argument that underlies both proposals in this application. My website/blog: yeehaa.io

## 1. Heroics Are Not Infrastructure

**Summary: On the disappearing apprenticeship: what happens to institutional judgment when no one has to practice it anymore.**
...
**Summary: On retrieval versus memory: why an institution that can find everything can still explain nothing.**
...
## 3. A Colleague Without Context

**Summary: On situated agency: what it costs an institution to give AI a role without ever defining one.**
