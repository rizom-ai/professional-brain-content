...
Ik ken dit probleem van meerdere kanten uit eigen praktijk. Door mijn werk voor PublicSpaces heb ik van dichtbij gezien hoe Nederlandse publieke organisaties, van omroepen tot culturele instellingen, expliciet op zoek zijn naar platformonafhankelijke infrastructuur, en hoe juist de laag ontbreekt waarmee hun eigen bronnen elkaar kunnen vinden en naar elkaar kunnen verwijzen. Met Offcourse heb ik open source gebouwd aan kennisdeling tussen praktijkmensen; één probleem is in die zeven jaar nooit opgelost: mensen die elkaar hadden moeten vinden, vonden elkaar niet, omdat matching op titels en bekendheid liep. En met Rizom verken ik hetzelfde probleem nu van de bouwkant, met zelfgehoste kennisbronnen op open protocollen: elke bron kan zelfstandig bestaan, maar er is geen afgesproken vorm waarin de ene de andere vindt. Drie routes, steeds dezelfde ontbrekende laag. Dit project bouwt die laag.
