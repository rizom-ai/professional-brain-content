...
Institutions invest in collections, buildings, and programs. Almost no one invests in the memory that holds them together.

A field that wants to build on itself needs infrastructure for knowledge that has to travel — between people, institutions, and generations.

---

## What a Rizom Brain is

A living knowledge environment for a person, a studio, an institution, or a field.
...
## An artist's practice travels with them

Artists move between studios, residencies, exhibitions, and institutions. A personal brain carries their research, references, works, and relationships along.

The practice stays theirs — portable, owned, never trapped in one institution's system.
...
Cultural knowledge should not be locked inside one company's platform.

Everything in a Rizom Brain stays portable and open. It belongs to the artists and institutions who made it — not to a technology vendor.
...
Artists carry their practice forward. Institutions build on their own histories. Programs learn from the programs before them. Knowledge that used to leave with people stays in the field.

The promise is not another archive. It is an art world that can remember, connect, and renew itself.
