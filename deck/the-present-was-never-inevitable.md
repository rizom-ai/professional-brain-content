...
slug: the-present-was-never-inevitable
description: >-
  A short reframing deck that breaks with the idea that innovation is only
  forward-looking. Innovation is not about worshipping the future; it is about
  seeing that the present was built, and can be rebuilt.
author: Yeehaa
status: draft
coverImageId: the-present-was-never-inevitable-cover
---
# The Present Was Never Inevitable
